...
from proto.tools.exam.ExamResultsAnalysis import ExamResultsReader,\
    ExamResultsAnalysis
...
class ExamDataEditTool(GeneralGuiTool):
    ...
    def getOptionsBoxColumnName(prevChoices): # Alternatively: getOptionsBox2()
        ...
        if prevChoices.resultsFile:
            resultsFN = extractFnFromDatasetInfo(prevChoices.resultsFile)
    ...
    def execute(choices, galaxyFn=None, username=''):
        ...
        '''
        resultsFN = extractFnFromDatasetInfo(choices.resultsFile)
